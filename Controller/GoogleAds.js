...
exports.createGoogleAdsLead = async (req, res) => {
    try {
        const {
            name,
            email,
...
exports.getGoogleAdsLeadByDatePDF = async (req, res) => {
    try {
        ...
        const contacts = await GoogleAds.find({
